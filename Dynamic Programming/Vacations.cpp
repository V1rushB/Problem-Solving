	...
	else
	{
		if (x == 1)
		{
			if (d[o] == 1)
				...
				dp[o][x] = min(dpcal(o + 1, 2), dpcal(o + 1, 0) + 1);
			else {
				dp[o][x] = min(dpcal(o + 1, 0) + 1, dpcal(o + 1, 2));
			}
		}
		else if (x == 2)
		{
			if (d[o] == 1)
				dp[o][x] = min(dpcal(o + 1, 1), dpcal(o + 1, 0) + 1);
			else if (d[o] == 2)
				dp[o][x] = dpcal(o + 1, 0) + 1;
			else {
				dp[o][x] = min(dpcal(o + 1, 0) + 1, dpcal(o + 1, 1));
			}
		}
		else if (x == 0) {
			//dp[o][x] = min({ dpcal(o + 1, 1), dpcal(o + 1, 2),dpcal(o + 1,0) });
			if (d[o] == 1)
				dp[o][x] = min(dpcal(o + 1, 0) + 1, dpcal(o + 1, 1));
			else if (d[o] == 2)
				dp[o][x] = min(dpcal(o + 1, 0) + 1, dpcal(o + 1, 2));
			else {
				dp[o][x] = min({ dpcal(o + 1, 0) + 1, dpcal(o + 1, 2),dpcal(o + 1,1) });
			}
		}
	}
	return dp[o][x];
