...
// Problem Link: https://codeforces.com/group/rkArIqWrpQ/contest/427050/problem/F
ll sum;

bool check(vector<ll>& d, ll h, ll val) {
	ll s(0),currw(0), currh(1);
