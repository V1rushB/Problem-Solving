...
void solution() {
    string str; cin >> str;
    int hrs,mins;
    hrs = ((str[0] - '0') * 10) + (str[1] - '0');
    mins = ((str[3] - '0') * 10) + (str[4] - '0');
    bool AM = hrs <12;
    cout << ((hrs == 12 || hrs == 0) ? to_string(12) : (hrs%12 < 10 ? "0" + to_string(hrs%12) : to_string(hrs%12))) << ':' << (mins < 10 ? "0" + to_string(mins) : to_string(mins)) << (AM ? " AM\n" : " PM\n");
